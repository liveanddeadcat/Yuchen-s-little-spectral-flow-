...
2. A machine that has >4G RAM and a fair CPU. Preferred if you configure your R (v>=4.5.2), Rstudio, VScode, and python so that they can use more GPU resources.
