...
### 20260525 Single-stained beads or cells spectra examples

```{r, fig.width=8, fig.height=3}
# beads
cd127_neg <- bead_control[names(bead_control)%in% "CD127_PECy7_b_neg.fcs"]
cd127_pos <- bead_control[names(bead_control) %in% "CD127_PECy7_b_pos.fcs"]
spectralplot(cd127_neg[[1]], bins = 50)
spectralplot(cd127_pos[[1]], bins = 50)


# cells
cd127_neg <- cell_control[names(cell_control)%in% "CD127_PECy7_c_neg.fcs"]
cd127_pos <- cell_control[names(cell_control) %in% "CD127_PECy7_c_pos.fcs"]
spectralplot(cd127_neg[[1]], bins = 50)
spectralplot(cd127_pos[[1]], bins = 50)
